      ...
      try {
        ...
        for (i = 0; i < maxClientsCount; i++) {
          if (threads[i] == null) {
            ...
            threads[i] = new clientThread(clientSocket, threads, nama); // obyek array of thread di object induk juga dilempar ke objeck anak (client thread)
            threads[i].start();
...
class clientThread extends Thread {
  ...
  public clientThread(Socket clientSocket, clientThread[] threads, List<String> nama) {
